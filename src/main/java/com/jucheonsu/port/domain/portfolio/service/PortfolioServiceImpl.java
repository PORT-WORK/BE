...
public class PortfolioServiceImpl implements PortfolioService {
    ...
    @Transactional public PortfolioResponse create(Long userId, PortfolioCreateRequest request) {
    ...
    @Transactional public PortfolioResponse getDetail(Long portfolioId) {
    ...
    @Transactional public PortfolioResponse update(Long userId, Long portfolioId, PortfolioUpdateRequest request) {
    ...
    @Transactional public void delete(Long userId, Long portfolioId) {
        Portfolio portfolio = portfolioRepository.findByIdAndUserIdAndDeletedAtIsNull(portfolioId, userId).orElseThrow(() -> new CustomException(ErrorCode.PORTFOLIO_NOT_FOUND));
        portfolio.delete();
    }
}
